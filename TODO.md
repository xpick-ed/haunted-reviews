...
**Doing:** 趣味性（DESIGN §31）：店裡的東西晚上用得到（安神茶、花露水、彈珠汽水、厚棉被、老照片、辦桌菜尾）；跟小翰的陰陽溝通（hanSense、鏡子、帳本、擲筊、托夢、收音機、多擺一碗飯、結局尾聲）；特別的夜晚（颱風夜、中元鬼客人夜）；今日好評分享卡。十四個自動測試全過。

**Next:**
1. 真機玩一輪：颱風夜 02:00 神明廳那一段的難度、鬼客人夜、菜櫥拿東西的手感、分享卡在手機上叫出 LINE
2. 結局畫面也放分享按鈕（ShareButton 現在讀 s.summary）
3. 逐步解鎖：第一個月只開家、村子、菜園、廟（內容越來越多，新玩家會被淹沒）
4. 新角色的對話頭像（很多角色現在顯示名字第一個字）
5. 燈塔改成走得進去、透天厝二樓；國小新教室的躲貓貓藏身處
