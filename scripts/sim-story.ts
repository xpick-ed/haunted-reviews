...
import { endingAtDawn, endingAtMonthEnd, DECISION_NIGHT, GOAL, TRAIN_MEMORIES } from '../src/world/story'
import { MEMORIES } from '../src/world/memories'

// 不 import director（它會帶進瀏覽器才有的語音模組）：只放結局判定會看的欄位
const base = (p: Partial<Meta>): Meta =>
  ({ night: 1, money: 20000, heart: 60, memories: [], pastDone: [], story: [], debtMonths: 0, ...p }) as unknown as Meta
