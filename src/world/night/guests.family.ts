...
// 志明和福伯所有人都會遇到；志偉（失業、半夜想不開）只在成人內容開著時出現。
...
export const FAMILY_GUESTS: Partial<Record<GuestId, GuestDef>> = {
  zhiming: {
    ...
    needs: [{ kind: 'insomnia', at: 23.6, chance: 0.8 }, { kind: 'cold', at: 26, chance: 0.5 }],
    clues: ['推著輪椅帶爸爸來', '一直在回訊息，眼睛很紅', '說：「爸爸以前很喜歡這種三合院。」'], shock: 20,
  },
  fubo: {
    id: 'fubo', name: '福伯', type: 'wanderer', label: '失智的爸爸（看得到阿嬤）', pay: 0, comfortNeed: 45, fearMax: 999, seesGhost: true, bedtime: 22.8, lightSleeper: 0.3, trips: [24.4],
    needs: [{ kind: 'thirsty', at: 23.5, chance: 0.5 }, { kind: 'cold', at: 25, chance: 0.6 }],
    clues: ['坐輪椅，一直叫一個女人的名字', '看到牆上的老照片就笑了', '口袋裡有一張泛黃的結婚照'], shock: 0,
  },
  zhiwei: {
    ...
    clues: ['穿著西裝來住民宿', '公事包裡只有一條領帶', '一直看著手機，但沒有打給任何人'], shock: 18,
  },
}
